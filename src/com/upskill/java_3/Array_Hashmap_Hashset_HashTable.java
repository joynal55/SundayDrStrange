...
public class Array_Hashmap_Hashset_HashTable {
	...
	public static void main(String[] args) {
		...
		//Array index				[0] [1] [2] [3] [4]    to get the data
		
		System.out.println(age);
		System.out.println(ageDrStrange[4]);
		System.out.println(ageDrStrange.length);
		
		String[] nameDrStrange = new String[]{"joynal", "ali", "john","smith"};
		System.out.println(nameDrStrange[0]);
		System.out.println(ageDrStrange.length);
	
		
		//Multi-Dimentional Array    // 
		int[][] ageDrStrange2D = {{25, 21, 30, 35, 28},  //[0][0] [0][01] [0][02] [0][3] [0][4]
									{30, 32, 25}};		//[1][0] [1][1] [1][2]
		...
		//HashSet store unordered collection unique, Implementation of set interface
